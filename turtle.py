...
def hide_toolbar():
	...
	if show_toolbar:
		...
		tool_bar.pack(side=tk.TOP, fill=tk.X)
		text_editor.pack(fill=tk.BOTH, expands=True)
		status_bar.pack(side=tk.BOTTOM)
		show_toolbar = True
...
view.add_checkbutton(label='Status Bar',onvalue=1, offvalue=False,variable=show_toolbar, image=status_bar_icon, compound=tk.LEFT, command=hide_statusbar)
